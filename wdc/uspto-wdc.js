...
(function () {
 ...
 myConnector.getSchema = function (schemaCallback) {
  var patentCols = [
   ...
   inventorCols = [
    ...
    {
     id: "inventor_county",
     alias: "inventor_county",
     dataType: tableau.dataTypeEnum.string
    },
    {
     id: "inventor_county_fips",
     alias: "inventor_county_fips",
     dataType: tableau.dataTypeEnum.string
    },
    {
     id: "inventor_state",
     alias: "inventor_state",
     dataType: tableau.dataTypeEnum.string
    },
    {
 ...
 myConnector.getData = function (table, doneCallback) {
  ...
  $.getJSON('https://www.patentsview.org/api/patents/query?q={' + filter + '}&o={"page":' + queryObj.page + ',"per_page":' + queryObj.per_page + ',"matched_subentities_only": "false"}&f=' + queryObj.f + '&s=[{"' + queryObj.sortKey + '":"' + queryObj.sortValue + '"}]', function (resp) {
 ...
 $(document).ready(function () {
  ...
  $("#submitButton").click(function () {
   var queryObj = {
    ...
    filter = queryObj.customFilter || '"' + queryObj.filterKey + '":"' + queryObj.filterValue + '"',
    finalURL = 'https://www.patentsview.org/api/patents/query?q={' + filter + '}&o={"page":' + queryObj.page + ',"per_page":' + queryObj.per_page + ',"matched_subentities_only": "true"}&f=' + queryObj.f + '&s=[{"' + queryObj.sortKey + '":"' + queryObj.sortValue + '"}]';
