...
(function () {
 ...
 myConnector.getData = function (table, doneCallback) {
  ...
  $.getJSON('http://www.patentsview.org/api/inventors/query?q={' + filter + '}&o={"page":' + queryObj.page + ',"per_page":' + queryObj.per_page + '}&f=' + queryObj.f + '&s=[{"' + queryObj.sortKey + '":"' + queryObj.sortValue + '"}]', function (resp) {
